...
# ==========================================
# 3. الاتصال والموديل - تحديث لاستخدام موديل أقوى
# ==========================================
...
def get_best_model():
    """الحصول على أفضل موديل - أولوية للموديلات الأقوى"""
    try:
        # أولوية للموديل الأقوى Pro أولاً
        priority_models = [
            'models/gemini-1.5-pro',      # الأقوى للإبداع
            'models/gemini-1.5-pro-latest',
            'models/gemini-2.0-flash-exp', # تجريبي قوي
            'models/gemini-1.5-flash',     # احتياطي
            'models/gemini-pro'
        ]
...
# ==========================================
# 5. القواعد والبرومبت - النسخة الإبداعية الذكية
# ==========================================
...
# ==========================================
# 6. منطقة العمل - مع إعدادات محسنة للإبداع
# ==========================================
...
if process_btn and input_text:
    ...
    with st.spinner('⏳ جاري الصياغة الإبداعية للنص...'):
        try:
            ...
            cfg = {
                "temperature": 0.85,  # زيادة للإبداع (كان 0.7)
                "max_output_tokens": 8192,
                "top_p": 0.95,
                "top_k": 50  # زيادة للتنوع (كان 40)
            }
...
with st.sidebar:
    ...
    if "pro" in current_model.lower():
        st.success("✅ وضع الإبداع العالي (Pro Model)")
    else:
        st.warning("⚠️ وضع عادي (Flash Model)")
